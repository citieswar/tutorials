...
Building requires 150 **[medals](../wars/combat.md#battle-medals)**. Each Connector has a usage limit of 20 marches before it expires.
...
Building requires 25 **[medals](../wars/combat.md#battle-medals)**, except when submitting the location for the first time, which will be reviewed by a moderator at no cost.
...
Building requires 25 **[medals](../wars/combat.md#battle-medals)**.
